...
## Create react app
Currently create react app requires ejecting or using a tool to modify the webpack config like: https://github.com/timarney/react-app-rewired/blob/master/README.md consider some of the alternatives for working with single-spa: https://github.com/facebook/create-react-app#popular-alternatives
