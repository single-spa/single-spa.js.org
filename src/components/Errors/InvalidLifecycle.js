...
export default function InvalidLifecycle(props) {
  return (
    <>
      <h1>
        #{props.errorCode}: Invalid {props.lifecycleName} lifecycle on{" "}
        {props.isParcel ? "parcel" : "application"}
      </h1>
      <p>
        The {props.isParcel ? "parcel" : "application"} {props.appOrParcelName}{" "}
        has an invalid {props.lifecycleName} lifecycle function.
      </p>
      <h2>To fix:</h2>
      <div>
      ...
      <p>
        ...
        <a
          href={
            props.isParcel
              ? "http://localhost:3000/docs/parcels-api/#parcel-object"
              : "https://single-spa.js.org/docs/building-applications/#lifecycle-props"
          }
        >
          {props.lifecycleName} lifecycle function
        </a>{" "}
        must be a function or array of functions that return a promise.
      </p>
    </>
  );
}
