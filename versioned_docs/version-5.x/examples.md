...
- [single-spa-template](https://github.com/gokingliu/single-spa-template): is a multi-bundler template with Vite3, Vue CLI 5, WebPack 5. All apps support standalone mode and single-spa mode.
